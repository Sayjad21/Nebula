...
with gr.Blocks() as demo:
    gr.Markdown("<h1 style='color: orange; text-align: center;  font-size: 4em;'> Nebula – Your Personal AI Assistant</h1>")
...
if __name__ == "__main__":
    try:
        ...
        print(f"Failed to create share link: {e}. Running locally at http://0.0.0.0:7860")
        demo.launch(
            server_name="0.0.0.0",
            server_port=7860,
            share=False,
